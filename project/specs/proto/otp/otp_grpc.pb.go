...
const (
	Otp_HealthCheck_FullMethodName       = "/otp.ProviderOtp/HealthCheck"
	Otp_GenerateCode_FullMethodName      = "/otp.ProviderOtp/GenerateCode"
	Otp_GenerateRetryCode_FullMethodName = "/otp.ProviderOtp/GenerateRetryCode"
	Otp_ValidateCode_FullMethodName      = "/otp.ProviderOtp/ValidateCode"
)

// OtpClient is the client API for ProviderOtp service.
//
...
// OtpServer is the server API for ProviderOtp service.
...
// Otp_ServiceDesc is the grpc.ServiceDesc for ProviderOtp service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Otp_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "otp.ProviderOtp",
